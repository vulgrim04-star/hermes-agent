...
ROOMS = [
 ...
 dict(id="sde", name="SALLE D'EAU", full="Salle d'eau", floor="carrelage", ang=-23.4,
      label=(3.15,4.55), poly=["Dw","D","Se","S"]),
]
...
WALLS = [
 ...
 dict(a="E", b="B1", t=EXT_T, ext=1, op=[dict(t0=1.55,t1=2.45,kind="win",sill=1.00),
                                         dict(t0=2.66,t1=3.02,kind="win",sill=1.15)]),
...
def along(ka, kb, t, off, ref=None):
...
at(along("W","N1",3.78,0.26), t="tv",   yaw=NW, w=1.45, d=0.45)
...
# ----------------------------------------------------------------- CUISINE
at(along("B1","E",0.62,0.33), t="cabinet", yaw=SU, w=0.65, d=0.62, h=1.28)
add(t="kitchen", x=0, y=0, ka="B1", kb="E", t0=1.00, t1=2.90, off=0.33, yaw=SU)
# ------------------------------------------------------------------ ENTRÉE
add(t="wardrobe", x=6.133, y=2.892, yaw=wallAng("Et","En"), w=1.95, d=0.80, h=1.30, doors=3)
# ------------------------------------------- CHAMBRE 2 → DRESSING + BUREAU
add(t="rug", x=2.10, y=1.60, yaw=NW, w=2.10, d=1.55, col="greige")
at(along("W","S",2.50,0.31), t="wardrobe", yaw=WE, w=3.10, d=0.60, h=1.28, doors=4)
at(along("A","D",1.48,0.32),  t="wardrobe", yaw=wallAng("A","D"), w=2.15, d=0.60, h=1.28, doors=3)
at(along("Dw","D",1.34,0.30), t="wardrobe", yaw=wallAng("Dw","D"), w=2.30, d=0.58, h=1.28, doors=3)
at(along("W","N1",1.40,0.32), t="desk", yaw=NW, w=1.30, d=0.60, h=0.74)
at(along("W","N1",1.40,0.92), t="chair", yaw=NW+180)
add(t="bench", x=2.10, y=1.60, yaw=NW, w=1.10, d=0.42, h=0.44)
add(t="plant", x=0.75, y=0.25, s=0.85)
# -------------------------------------------------------------- SALLE D'EAU
at(along("B2","S",0.55,0.28), t="basin",  yaw=SO-180, w=0.80)
at(along("B2","S",1.35,0.35), t="wc",     yaw=SO-180)
at(along("B2","S",2.15,0.52), t="shower", yaw=SO-180, w=1.00, d=0.95)
at(along("W","S",4.85,0.34),  t="appliance", yaw=WE, stack=1)
# ------------------------------------------------------------------ LOGGIA
...
# ----------------------------------------------------------------- CHAMBRE
add(t="rug", x=11.35,y=0.10, yaw=NO, w=2.70, d=2.30, col="greige")
add(t="bed", x=11.41,y=0.05, yaw=round(NO+90,2), w=1.45, l=2.00)
at(along("N2","E",2.05,0.30), t="wardrobe", yaw=ES, w=1.90, d=0.55, h=1.28, doors=3)
at(along("K1","K2",1.05,0.30), t="wardrobe", yaw=wallAng("K1","K2"), w=1.60, d=0.60, h=1.22, doors=2)
# ----------------------------------------------------------- SALLE DE BAINS
at(along("H1","H4",1.05,0.42), t="tub", yaw=wallAng("H1","H4"), w=0.75, l=1.65)
at(along("E","B1",1.15,0.35),  t="wc",  yaw=SU)
at(along("E","B1",0.48,0.28),  t="basin", yaw=SU, w=0.85)
at(along("H1","H4",0.36,0.30), t="cabinet", yaw=wallAng("H1","H4"), w=0.55, d=0.42, h=0.95)
