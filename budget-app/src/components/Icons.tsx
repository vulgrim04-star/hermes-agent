...
export const IconWealth = (p: Props) => (
  <Glyph {...p}>
    <path d="M4 19.5h16" />
...
/** Budgets — une enveloppe par poste, et ce qu'il en reste. */
export const IconBudget = (p: Props) => (
  <Glyph {...p}>
    <path d="M3.5 8.6 12 4.5l8.5 4.1v8.8L12 21.5l-8.5-4.1Z" />
    <path d="M3.5 8.6 12 12.7l8.5-4.1" />
    <path d="M12 12.7v8.8" />
  </Glyph>
);
