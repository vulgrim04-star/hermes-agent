...
import { PUBLIC_SUPABASE_KEY, PUBLIC_SUPABASE_URL } from './supabase.public.js';
 ...
 * trompe. `import.meta.env` reste consulté pour le développement local, et le
 * projet du ménage sert de dernier recours : sans lui, une construction sans
 * variable donnerait un site qui s'ouvre sur son écran de configuration.
 *
 * L'ordre compte : une variable posée explicitement doit toujours l'emporter
 * sur la valeur inscrite dans le code, sans quoi on ne pourrait plus pointer un
 * autre projet.
 */
